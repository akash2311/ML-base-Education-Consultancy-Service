      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>Akash Pattanayak</Trans></h5>
                  <span><Trans>Student</Trans></span>
                </div>
              </div>
              <Dropdown alignRight>
          ...
          <li className="nav-item nav-category">
            <span className="nav-link"><Trans>Menu Items</Trans></span>
          </li>
          ...
          <li className={ this.isPathActive('/forms') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/forms">
              <span className="menu-icon"><i className="mdi mdi-format-align-left"></i></span>
              <span className="menu-title"><Trans>Explore Career</Trans></span>
            </Link>
          </li>
